...
public class ModulesResource {
     ...
     */
    @PostMapping("/modules")
    public ResponseEntity<Modules> createModules(@RequestBody Modules modules) throws URISyntaxException {
    ...
    public ResponseEntity<Modules> updateModules(@PathVariable(value = "id", required = false) final Long id, @RequestBody Modules modules)
