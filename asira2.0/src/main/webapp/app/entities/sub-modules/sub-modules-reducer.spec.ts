...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBMODULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBMODULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBMODULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBMODULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBMODULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBMODULES actions', async () => {
      const expectedActions = [
        {
