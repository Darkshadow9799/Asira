...
export class RequestDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('asiraApp.request.delete.question'));
...
export default class RequestComponentsPage {
  ...
  async deleteRequest() {
    ...
    expect(await requestDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/asiraApp.request.delete.question/);
