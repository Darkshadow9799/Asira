...
class SpeResourceIT {
    ...
    private static final Long DEFAULT_SPE_ORG_ID = 1L;
    private static final Long UPDATED_SPE_ORG_ID = 2L;
...
//        assertThat(testSpe.getSpeOrgId()).isEqualTo(DEFAULT_SPE_ORG_ID);
...
//            .andExpect(jsonPath("$.[*].speOrgId").value(hasItem(DEFAULT_SPE_ORG_ID.intValue())))
...
//            .andExpect(jsonPath("$.speOrgId").value(DEFAULT_SPE_ORG_ID.intValue()))
...
//        assertThat(testSpe.getSpeOrgId()).isEqualTo(UPDATED_SPE_ORG_ID);
...
//
//        partialUpdatedSpe.speOrgVerified(UPDATED_SPE_ORG_VERIFIED);
//
//        restSpeMockMvc
//            .perform(
