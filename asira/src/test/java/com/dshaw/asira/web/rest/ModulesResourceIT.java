...
class ModulesResourceIT {
    ...
    private static final Long DEFAULT_M_SPE_ID = 1L;
    private static final Long UPDATED_M_SPE_ID = 2L;

    private static final Long DEFAULT_M_PROJ_ID = 1L;
    private static final Long UPDATED_M_PROJ_ID = 2L;
...
//            .mSpeId(DEFAULT_M_SPE_ID)
//            .mProjId(DEFAULT_M_PROJ_ID)
...
//            .mSpeId(UPDATED_M_SPE_ID)
//            .mProjId(UPDATED_M_PROJ_ID)
...
//        assertThat(testModules.getmSpeId()).isEqualTo(DEFAULT_M_SPE_ID);
//        assertThat(testModules.getmProjId()).isEqualTo(DEFAULT_M_PROJ_ID);
...
//    @Test
//    @Transactional
//    void checkmSpeIdIsRequired() throws Exception {
//        int databaseSizeBeforeTest = modulesRepository.findAll().size();
//        // set the field null
//        modules.setmSpeId(null);
//
...
//    @Test
//    @Transactional
//    void checkmProjIdIsRequired() throws Exception {
//        int databaseSizeBeforeTest = modulesRepository.findAll().size();
//        // set the field null
//        modules.setmProjId(null);
//
//        // Create the Modules, which fails.
//
//        restModulesMockMvc
...
//            .andExpect(jsonPath("$.[*].mSpeId").value(hasItem(DEFAULT_M_SPE_ID.intValue())))
//            .andExpect(jsonPath("$.[*].mProjId").value(hasItem(DEFAULT_M_PROJ_ID.intValue())))
...
//            .andExpect(jsonPath("$.mSpeId").value(DEFAULT_M_SPE_ID.intValue()))
//            .andExpect(jsonPath("$.mProjId").value(DEFAULT_M_PROJ_ID.intValue()))
...
//        assertThat(testModules.getmSpeId()).isEqualTo(UPDATED_M_SPE_ID);
//        assertThat(testModules.getmProjId()).isEqualTo(UPDATED_M_PROJ_ID);
