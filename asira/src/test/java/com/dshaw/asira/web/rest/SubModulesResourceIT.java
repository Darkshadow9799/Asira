...
class SubModulesResourceIT {
    ...
    private static final Long DEFAULT_SM_M_ID = 1L;
    private static final Long UPDATED_SM_M_ID = 2L;

    private static final Long DEFAULT_SM_SPE_ID = 1L;
    private static final Long UPDATED_SM_SPE_ID = 2L;
    ...
    private static final Long DEFAULT_SM_TAG_ID = 1L;
    private static final Long UPDATED_SM_TAG_ID = 2L;

    private static final Long DEFAULT_SPE_ID_SM_TAG_ID = 1L;
    private static final Long UPDATED_SPE_ID_SM_TAG_ID = 2L;
...
//            .smMId(DEFAULT_SM_M_ID)
//            .smSpeId(DEFAULT_SM_SPE_ID)
...
//            .smTagID(DEFAULT_SM_TAG_ID)
//            .speIdSmTagId(DEFAULT_SPE_ID_SM_TAG_ID)
...
//            .smMId(UPDATED_SM_M_ID)
//            .smSpeId(UPDATED_SM_SPE_ID)
...
//            .smTagID(UPDATED_SM_TAG_ID)
//            .speIdSmTagId(UPDATED_SPE_ID_SM_TAG_ID)
...
//        assertThat(testSubModules.getSmMId()).isEqualTo(DEFAULT_SM_M_ID);
//        assertThat(testSubModules.getSmSpeId()).isEqualTo(DEFAULT_SM_SPE_ID);
...
//        assertThat(testSubModules.getSmTagID()).isEqualTo(DEFAULT_SM_TAG_ID);
//        assertThat(testSubModules.getSpeIdSmTagId()).isEqualTo(DEFAULT_SPE_ID_SM_TAG_ID);
...
//    @Test
//    @Transactional
//    void checkSmMIdIsRequired() throws Exception {
//        int databaseSizeBeforeTest = subModulesRepository.findAll().size();
//        // set the field null
//        subModules.setSmMId(null);
//
//        // Create the SubModules, which fails.
//
//        restSubModulesMockMvc
//            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(subModules)))
//            .andExpect(status().isBadRequest());
//
//        List<SubModules> subModulesList = subModulesRepository.findAll();
//        assertThat(subModulesList).hasSize(databaseSizeBeforeTest);
//    }
//
//    @Test
//    @Transactional
//    void checkSmSpeIdIsRequired() throws Exception {
//        int databaseSizeBeforeTest = subModulesRepository.findAll().size();
//        // set the field null
//        subModules.setSmSpeId(null);
//
//        // Create the SubModules, which fails.
//
//        restSubModulesMockMvc
...
//            .andExpect(jsonPath("$.[*].smMId").value(hasItem(DEFAULT_SM_M_ID.intValue())))
//            .andExpect(jsonPath("$.[*].smSpeId").value(hasItem(DEFAULT_SM_SPE_ID.intValue())))
...
//            .andExpect(jsonPath("$.[*].smTagID").value(hasItem(DEFAULT_SM_TAG_ID.intValue())))
//            .andExpect(jsonPath("$.[*].speIdSmTagId").value(hasItem(DEFAULT_SPE_ID_SM_TAG_ID.intValue())))
...
//            .andExpect(jsonPath("$.smMId").value(DEFAULT_SM_M_ID.intValue()))
//            .andExpect(jsonPath("$.smSpeId").value(DEFAULT_SM_SPE_ID.intValue()))
...
//            .andExpect(jsonPath("$.smTagID").value(DEFAULT_SM_TAG_ID.intValue()))
//            .andExpect(jsonPath("$.speIdSmTagId").value(DEFAULT_SPE_ID_SM_TAG_ID.intValue()))
...
//        assertThat(testSubModules.getSmMId()).isEqualTo(UPDATED_SM_M_ID);
//        assertThat(testSubModules.getSmSpeId()).isEqualTo(UPDATED_SM_SPE_ID);
...
//        assertThat(testSubModules.getSmTagID()).isEqualTo(UPDATED_SM_TAG_ID);
//        assertThat(testSubModules.getSpeIdSmTagId()).isEqualTo(UPDATED_SPE_ID_SM_TAG_ID);
