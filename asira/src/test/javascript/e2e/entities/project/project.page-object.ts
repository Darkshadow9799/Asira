...
export class ProjectDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('asiraApp.project.delete.question'));
...
export default class ProjectComponentsPage {
  ...
  async deleteProject() {
    ...
    expect(await projectDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/asiraApp.project.delete.question/);
