...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('asiraApp.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/asiraApp.tag.delete.question/);
