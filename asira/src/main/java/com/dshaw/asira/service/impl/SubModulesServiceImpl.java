    ...
    public Optional<SubModules> partialUpdate(SubModules subModules) {
        ...
        return subModulesRepository
            ...
            .map(existingSubModules -> {
                ...
                if (subModules.getSmMId() != null) {
                    existingSubModules.setSmMId(subModules.getSmMId());
                }
                if (subModules.getSmSpeId() != null) {
                    existingSubModules.setSmSpeId(subModules.getSmSpeId());
                }
                ...
                if (subModules.getSmTagID() != null) {
                    existingSubModules.setSmTagID(subModules.getSmTagID());
                }
                if (subModules.getSpeIdSmTagId() != null) {
                    existingSubModules.setSpeIdSmTagId(subModules.getSpeIdSmTagId());
                }
