...
public class ProjectResource {
    ...
    public ResponseEntity<Project> createProject(@Valid @RequestBody Project project) throws URISyntaxException {
        ...
        SpeProj speProj = new SpeProj();
        Project result = projectService.save(project);
        createSpeProj(speProj, result);
    ...
    private void createSpeProj(SpeProj speProj, Project result) {
        speProj.setProjId(result.getId());
        speProj.setSpeId(result.getProjAdminId());
        speProj.setOrgId(result.getOrgId());
        speProjService.save(speProj);
    }
