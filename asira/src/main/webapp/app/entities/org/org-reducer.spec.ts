...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './org.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORG_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORG actions', async () => {
      const expectedActions = [
        {
