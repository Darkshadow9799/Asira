...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './spe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPE actions', async () => {
      const expectedActions = [
        {
