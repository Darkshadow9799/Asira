          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('smMId')}>
                  <Translate contentKey="asiraApp.subModules.smMId">Sm M Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('smSpeId')}>
                  <Translate contentKey="asiraApp.subModules.smSpeId">Sm Spe Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('smTagID')}>
                  <Translate contentKey="asiraApp.subModules.smTagID">Sm Tag ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('speIdSmTagId')}>
                  <Translate contentKey="asiraApp.subModules.speIdSmTagId">Spe Id Sm Tag Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {subModulesList.map((subModules, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{subModules.smMId}</td>
                  <td>{subModules.smSpeId}</td>
                  <td>
                  ...
                  <td>{subModules.smTagID}</td>
                  <td>{subModules.speIdSmTagId}</td>
