    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="smMId">
              <Translate contentKey="asiraApp.subModules.smMId">Sm M Id</Translate>
            </span>
          </dt>
          <dd>{subModulesEntity.smMId}</dd>
          <dt>
            <span id="smSpeId">
              <Translate contentKey="asiraApp.subModules.smSpeId">Sm Spe Id</Translate>
            </span>
          </dt>
          <dd>{subModulesEntity.smSpeId}</dd>
          <dt>
          ...
          <dt>
            <span id="smTagID">
              <Translate contentKey="asiraApp.subModules.smTagID">Sm Tag ID</Translate>
            </span>
          </dt>
          <dd>{subModulesEntity.smTagID}</dd>
          <dt>
            <span id="speIdSmTagId">
              <Translate contentKey="asiraApp.subModules.speIdSmTagId">Spe Id Sm Tag Id</Translate>
            </span>
          </dt>
          <dd>{subModulesEntity.speIdSmTagId}</dd>
          <dt>
