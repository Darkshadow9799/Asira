...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './com.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COM_LIST actions', async () => {
    ...
    it('dispatches FETCH_COM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COM actions', async () => {
      const expectedActions = [
        {
