...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './spe-proj.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEPROJ_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPEPROJ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPEPROJ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPEPROJ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPEPROJ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPEPROJ actions', async () => {
      const expectedActions = [
        {
