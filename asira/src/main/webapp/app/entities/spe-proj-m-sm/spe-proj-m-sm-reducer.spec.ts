...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEPROJMSM_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPEPROJMSM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPEPROJMSM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPEPROJMSM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPEPROJMSM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPEPROJMSM actions', async () => {
      const expectedActions = [
        {
